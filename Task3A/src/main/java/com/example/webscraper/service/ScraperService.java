...
//        final List<WebElement> wordList = words.findElements(By.className("inner_content"));
        ...
        textExpanded.click();
        textExpanded.sendKeys("hello again");
        Thread.sleep(3000);
        WebElement postButton = driver.findElement(By.cssSelector("div[aria-label='Post']"));
        postButton.click();
        Thread.sleep(3000);

        WebElement dropDown = driver.findElementByCssSelector("div[aria-label='Account']");
        dropDown.click();
        Thread.sleep(3000);
        //WebElement logout = driver.findElement(By.cssSelector("div[class='aov4n071']:nth-child(3):nth-child(1):nth-child(4) > div[role='button']"));
